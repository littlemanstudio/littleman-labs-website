  ...
  return (
    <section className="px-6 pt-32 pb-28">
      <div className="mx-auto max-w-2xl">
        <h1 className="font-display text-[length:var(--fs-h3)] font-extrabold text-bone">{t("terms.h1")}</h1>
        <p className="mt-4 text-bone-dim">{t("terms.lede")}</p>
        <p className="mt-2 font-mono text-xs text-bone-faint">{t("terms.updated")}</p>
